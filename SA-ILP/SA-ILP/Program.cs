...
//solver.SolveVRPLTTInstance(Path.Join(baseDir, "vrpltt_instances/large", "madrid_full.csv"), numLoadLevels: 10, numIterations: 0, timelimit: 500 * 1000,bikeMinMass:140,bikeMaxMass:290,inputPower:350);
