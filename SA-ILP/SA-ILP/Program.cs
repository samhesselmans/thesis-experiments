...
solver.SolveVRPLTTInstance(Path.Join(baseDir, "vrpltt_instances/large", "seattle_full.csv"), numLoadLevels: 10, numIterations: 50000000, timelimit: 500 * 1000,bikeMinMass:140,bikeMaxMass:290,inputPower:350,config:LocalSearchConfigs.VRPSLTT);
