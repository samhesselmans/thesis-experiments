...
#vrpltt_instances\large\pittsburgh_full.csv
instance_madrid_full = "../vrpltt_instances/large/madrid_full.csv"
instance_pittsburgh_full = "vrpltt_instances/large/pittsburgh_full.csv"
...
def CompareSolutions(solutions,instance):

    if len(solutions) < 2:
        Exception("Not enough solutions provided")

    newSolutions = [solutions[0]]
    for i in range(1,len(solutions)):
        (_,newSol) = OrderSolution(solutions[0],solutions[i])
...
# solution19=[(0,72,82,55,86,13,93,79,8,17,92,91,25,53,0),
# (0,94,2,36,37,23,69,78,0),
# (0,56,47,39,44,19,60,7,41,95,9,16,29,0),
# (0,71,100,28,75,24,27,32,61,22,96,51,10,31,46,42,84,0),
# (0,40,48,83,90,4,66,3,45,50,57,58,73,0),
# (0,80,68,81,35,97,54,87,59,26,49,15,34,0),
# (0,20,18,52,38,43,88,85,74,1,70,99,11,33,77,76,0),
# (0,62,21,65,5,6,30,14,63,67,12,89,98,64,0),]
...
pitt01 = [(0,62,27,74,5,11,28,76,31,9,83,10,73,93,0),
(0,60,3,67,20,56,42,52,78,57,19,82,85,53,15,0),
(0,90,17,32,71,34,33,100,30,87,70,40,63,18,8,23,0),
(0,59,98,91,4,22,37,69,50,72,96,16,35,75,1,97,51,0),
(0,65,45,99,88,14,68,25,41,86,66,24,89,29,21,46,0),
(0,64,13,54,58,7,61,84,77,38,49,95,6,94,47,44,0),
(0,79,81,92,80,36,26,48,55,43,2,12,39,0),]
pitt0min1 = [(0,60,0),
(0,74,5,83,11,28,76,31,9,10,73,93,0),
(0,92,65,13,54,58,98,91,72,96,16,35,12,39,0),
(0,94,17,84,4,22,37,69,50,61,7,64,75,1,2,43,55,97,51,0),
(0,90,24,100,33,34,66,86,87,70,40,63,8,18,0),
(0,79,81,23,21,89,77,38,49,32,71,6,95,47,44,29,0),
(0,62,27,3,67,20,56,42,52,78,57,19,82,85,15,0),
(0,53,48,45,99,30,68,59,25,41,14,88,26,80,36,46,0),]
pitt10 = [(0,62,27,5,83,11,28,76,31,9,10,73,93,74,0),
(0,39,60,0),
(0,3,67,20,56,42,78,52,57,19,82,26,51,15,0),
(0,90,17,71,32,6,38,77,44,89,29,21,46,0),
(0,53,48,13,54,58,7,61,64,75,12,2,43,55,97,85,0),
(0,94,91,72,4,22,37,69,50,16,35,96,98,84,49,95,0),
(0,45,99,88,30,68,25,59,41,34,33,100,66,86,24,47,0),
(0,79,81,92,80,36,65,1,14,87,70,40,63,18,8,23,0),]
pittmin10 = [(0,62,27,3,67,5,11,28,31,9,83,10,73,93,74,0),
(0,94,45,99,30,14,68,59,41,77,38,49,32,71,6,95,47,0),
(0,60,15,53,92,80,36,26,48,65,97,51,46,0),
(0,23,90,24,34,33,66,86,87,70,40,63,18,8,44,0),
(0,84,98,4,22,37,69,50,61,7,64,75,88,1,2,43,55,85,0),
(0,79,81,42,82,19,57,52,78,89,29,21,76,56,20,0),
(0,17,100,25,13,54,58,91,72,96,16,35,12,39,0),]



CompareSolutions([pitt01,pitt0min1,pitt10,pittmin10],instance_pittsburgh_full)
